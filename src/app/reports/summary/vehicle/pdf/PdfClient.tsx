...
import type { EventSummaryRecord } from '@/components/reports/VehicleSummaryReport'

export default function PdfClient({ records, fromDate, toDate }: { records: EventSummaryRecord[], fromDate: string, toDate: string }) {
  ...
  return (
    <div className='flex h-screen w-full flex-col'>
      <PDFViewer className='min-h-screen w-full border-none'>
        <VehicleSummaryReport records={safeRecords} fromDate={fromDate} toDate={toDate} />
      </PDFViewer>
    </div>
  )
}
