...
import type { IntrusionEventRecord } from '@/app/(dashboard)/vehicles/intrusion/page'
import IntrusionReport from '@/components/reports/IntrusionReport'
import { getIntrusionData } from '@/app/server/action'
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const downloadPdf = async () => {
      ...
      a.href = url
      a.download = `intrusion-report-${from}-to-${to}.pdf`
      a.click()
